...
public class CDal {
	...
	public static boolean createCourse(String courseName, int teachingUnit, int teachingHours, int preCourseId) {
		...
		try {
			if (isCourseExist(courseName)) {
				...
				Statement stmt = connection.createStatement();
				stmt.executeUpdate("INSERT INTO course (name, teachingUnit_teachingUnitId, teachingHours, preCourse) VALUES ('"
						+ courseName + "',"  + teachingUnit + "," + teachingHours + ","+ preCourseId +")");
